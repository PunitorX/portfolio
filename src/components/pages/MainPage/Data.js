...
export const mainData = {
    ...
    pTwo: "Jump forward to the current present, and I am now working with React JS, building my own websites and obtaining any sort of experience I can. I've messed around with both front-end and back-end technologies, putting together simple applications and building databases.",
    pThree: ''
}
