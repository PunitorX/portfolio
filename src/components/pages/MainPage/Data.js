...
export const projectData = {
    ...
    bodyOne: 'Marketplace is a current e-commerce project for Direct Software Solutions. It is used to sell and create custom templates. Customers can either buy pre-built templates or design one of their own using given components.',
    ...
    listOne: 'React JS, Styled Components, Node Js, Express.js, MongoDB',
